...
func BenchmarkNewInputSub(b *testing.B) {
	testcases := []struct {
		url string
	}{
		{url: "something.scanme.sh"},
		{url: "nested.something.scanme.sh"},
		{url: "nested.multilevel.scanme.co.uk"},
		{url: "sub.level1.level2.scanme.sh"},
		{url: "scanme.sh"},
	}
